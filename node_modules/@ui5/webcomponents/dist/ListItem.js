...
import { DELETE, ARIA_LABEL_LIST_ITEM_CHECKBOX, ARIA_LABEL_LIST_ITEM_RADIO_BUTTON, LIST_ITEM_SELECTED, LIST_ITEM_NOT_SELECTED,
// @ts-ignore
...
let ListItem = ListItem_1 = class ListItem extends ListItemBase {
    ...
    onMultiSelectionComponentPress(e) {
        ...
        this.fireEvent("_selection-requested", { item: this, selected: e.target.checked, selectionComponentPressed: true }); // Switch HTMLInputElement to CheckBox when ui5-check is migrated to TypeScript
    }
    onSingleSelectionComponentPress(e) {
        if (this.isInactive) {
            return;
        }
        this.fireEvent("_selection-requested", { item: this, selected: !e.target.selected, selectionComponentPressed: true });
    }
    activate() {
