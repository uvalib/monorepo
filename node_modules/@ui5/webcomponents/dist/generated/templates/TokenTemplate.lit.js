...
const block1 = (context, tags, suffix) => html`<div class="ui5-token--icon" @mousedown="${context._mousedown}" @click="${context._delete}">${ context.closeIcon.length ? block2(context, tags, suffix) : block3(context, tags, suffix) }</div>`;
