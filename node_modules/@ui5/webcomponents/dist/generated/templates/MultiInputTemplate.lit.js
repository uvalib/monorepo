...
const block5 = (context, tags, suffix) => html`<${scopeTag("ui5-icon", tags, suffix)} @click=${context._clear} tabindex="-1" input-icon class="ui5-input-clear-icon" name="decline"></${scopeTag("ui5-icon", tags, suffix)}>`;
const block6 = (context, tags, suffix) => html`<div class="ui5-input-icon-root"><slot name="icon"></slot></div>`;
const block7 = (context, tags, suffix) => html`<${scopeTag("ui5-icon", tags, suffix)} @click=${context.valueHelpPress} @mousedown=${context.valueHelpMouseDown} @mouseup=${context.valueHelpMouseUp} input-icon name="value-help"></${scopeTag("ui5-icon", tags, suffix)}>`;
const block8 = (context, tags, suffix) => html`<span id="${ifDefined(context._id)}-suggestionsText" class="ui5-hidden-text">${ifDefined(context.suggestionsText)}</span><span id="${ifDefined(context._id)}-selectionText" class="ui5-hidden-text" aria-live="polite" role="status"></span><span id="${ifDefined(context._id)}-suggestionsCount" class="ui5-hidden-text" aria-live="polite">${ifDefined(context.availableSuggestionsCount)}</span>`;
const block9 = (context, tags, suffix) => html`<span id="${ifDefined(context._id)}-descr" class="ui5-hidden-text">${ifDefined(context.accInfo.input.ariaDescription)}</span>`;
const block10 = (context, tags, suffix) => html`<span id="${ifDefined(context._id)}-valueStateDesc" class="ui5-hidden-text">${ifDefined(context.ariaValueStateHiddenText)}</span>`;
