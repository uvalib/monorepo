...
const block3 = (context, tags, suffix) => html`<div id="${ifDefined(context._id)}-before" tabindex="0" role="none" class="ui5-list-focusarea"></div>`;
...
const block7 = (context, tags, suffix) => html`<div id="${ifDefined(context._id)}-after" tabindex="0" role="none" class="ui5-list-focusarea"></div>`;
