...
keywords: >-
  University of Virginia, Board of Visitors, meeting minutes, education,
  governance
description: >-
  Minutes from the Board of Visitors meeting held on June 11-13, 1900, detailing
  financial transactions, faculty appointments, and committee recommendations.
attendee:
  - '@type': Person
    name: C. P. Jones
    role: Rector
...
21. In this connection, attention is called to the resolution of the Visitors of June 29th 1881, to be found on page 128 of the minutes of the Board:
...
Resolved further that no one of these scholarships be awarded to the same student more than for one session.
