...
description: >-
  Minutes of the Board of Visitors meeting held on June 27-28, 1887, detailing
  discussions on faculty appointments, salaries, repairs, and improvements, as
  well as reports from various committees.
attendee:
  - '@type': Person
    name: Holmes Conrad
  - '@type': Person
...
about:
  - '@type': Report
    ...
    description: >-
      Report detailing the actions and recommendations of the Executive
      Committee regarding the establishment of a School of Pharmacy and other
      university matters.
  - '@type': Report
    name: Faculty Report
    description: >-
      Report from the Faculty on the condition of the University, including
      recommendations for improvement and updates on student attendance.
---
