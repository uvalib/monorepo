...
description: >-
  Minutes of the Board of Visitors meeting held on November 30, 1984, detailing
  actions taken regarding the authorization and securing of Fixed/Adjustable
  Rate Hospital Revenue Bonds (Series B) and other board actions.
attendee: []
about:
  - '@type': Thing
    name: Fixed/Adjustable Rate Hospital Revenue Bonds (Series B)
    description: >-
      Resolution adopted authorizing the issuance of Fixed/Adjustable Rate
      Hospital Revenue Bonds.
  - '@type': Thing
    name: Virginia Freedom of Information Act
    description: >-
      Public minutes have had salary information deleted in accordance with the
