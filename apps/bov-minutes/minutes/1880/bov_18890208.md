...
description: >-
  Official minutes include discussions on faculty salaries, academic degrees,
  and other board actions from the University of Virginia.
extent:
  - '@value': 0 pages
edition:
  - '@value': Public minutes
source_checksum: 99b41a607595377f3b4584a8a4aaaa03fbc4f70d53427d0dfb9bf5be38034b6c
...
participants:
  ...
  - name: Profr Thornton
    role: Chairman
  - name: Profr Geo. Fred'k Holmes
    role: Professor
  - name: Profr M. Schele Devere
    role: Professor
  - name: J. L. Cabell
    role: Professor
  - name: Francis Epps Shine
    role: Student request
  - name: Benj. F. Brown
    role: Executor
  - name: Jas D. Jones
    role: Secretary
