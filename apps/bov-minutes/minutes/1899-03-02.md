...
description: >-
  Minutes of the Board of Visitors meeting held on March 2-3, 1899, covering
  personnel decisions, construction plans, and financial resolutions.
attendee:
  - '@type': Person
  ...
  - '@type': Person
    name: Dr. W. A. Lambeth
  - '@type': Person
    name: Col. Thos H. Carter
  - '@type': Person
    name: Prof. R. C. Minor
  - '@type': Person
    name: Col. John B. Cary
  - '@type': Person
    name: Mr. T. A. Cary
about:
  - '@type': Thing
    name: Randall Dormitory Building Plans
  - '@type': Thing
