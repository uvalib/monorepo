...
keywords: Board of Visitors, University of Virginia, minutes, February 1889
description: >-
  Minutes from the Board of Visitors meeting held on February 8-9, 1889,
  covering various administrative decisions, committee reports, and resolutions
  regarding the university's operations and academic programs.
attendee:
  - '@type': Person
    name: Hon. John L. Marye
  - '@type': Person
    name: W. C. N. Randolph
  - '@type': Person
    name: R. M. Stuart
...
1. The scope & purpose of the instruction given in the subjects required for the degree to be such as shall have for its chief end a sound general knowledge of each subject.
