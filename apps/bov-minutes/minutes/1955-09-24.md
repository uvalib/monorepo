...
description: >-
  Minutes of the Board of Visitors meeting held on September 24, 1955, detailing
  discussions on faculty appointments, leave of absence, resolutions on
  athletics, and other board actions.
attendee:
  - Barron F. Black
  - Colgate W. Darden, Jr.
  - A. D. Barksdale
...
about:
  - '@type': Person
    name: Mr. Alexander V. Thelen
    role: Part-time Lecturer in Economics
    salary: $1,200
  - '@type': Person
    name: Mrs. Charles D. Shelden
    role: Acting Instructor in Nursing
    salary: $3,456
  - '@type': Person
    name: Mr. Roger Durgin Johnson, Jr.
    role: Instructor in Mathematics
    salary: $4,000
  - '@type': Person
