...
keywords: >-
  Board of Visitors, University of Virginia, resolutions, appointments, faculty
  decisions, Cyrus Harding Walker memorial
description: >-
  Official minutes of the Board of Visitors meeting held on May 3, 1934,
  including resolutions on the death of Cyrus Harding Walker and various board
  actions.
attendee:
  - '@type': Person
    name: Fred W. Scott
...
about:
  - '@type': Event
    name: Resolutions on the Death of Cyrus Harding Walker
    description: >-
      Resolutions adopted in memory of Cyrus Harding Walker, a member of the
      Board for over sixteen years.
  - '@type': Event
    name: Special Meeting of the Rector and Visitors
    description: >-
      Meeting held to discuss various board actions, including financial
