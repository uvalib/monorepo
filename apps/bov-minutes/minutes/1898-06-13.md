...
description: >-
  ...
  June 13, 1898. The minutes detail faculty reports, financial appropriations,
  committee appointments, and resolutions regarding university operations.
attendee:
  - Charles P. Jones
  - Harmon
  - Bryan
...
about:
  ...
  - '@type': Report
    name: Commr of Account's report
  - '@type': Report
    name: Librarian's report
  - '@type': Report
    name: School reports
---
...
that the Secretary be, and he is hereby directed to advise Mr Spi-Kanta, that the only way to obtain a degree at this institution is to take a prescribed course of study here and then pass a satisfactory written examination thereon, and this is the invariable rule.
