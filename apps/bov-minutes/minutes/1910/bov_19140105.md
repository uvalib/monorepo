...
description: >-
  Official minutes of the Board of Visitors meeting detailing the discussions
  surrounding the merger of the Medical College of Virginia and various other
  matters important to the institution.
extent:
  - '@value': 0 pages
edition:
  - '@value': Public minutes
source_checksum: a9df2e71f406ed01eff90d1e1c33b147e185c4bb93f64bead2cbc318a9467c1e
...
participants:
  ...
  - name: Whitehead
    role: Doctor
  - name: 'Eppa Hunton, Jr.'
    role: 'Chairman, Executive Committee'
  - name: S. C. Mitchell
    role: 'President, Medical College of Virginia'
  - name: L. Z. Morris
    role: 'Member, Medical College of Virginia'
  ...
  - name: Charles Hancock
    role: 'Professor, Engineering Department'
...
Whereas, the Rector and Visitors further believe that one practical and efficient mode of meeting this need would be found in the creation of a woman's college co-ordinate with the University; therefore be it 
**Resolved**, That it is the sense of the Rector and Visitors that the first step should be the appointment by the General Assembly of Virginia of a competent commission to make a thorough and searching investigation, and a careful and detailed examination into the costs of founding and maintaining such college.
