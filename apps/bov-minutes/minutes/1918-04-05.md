...
keywords: >-
  Board of Visitors, university governance, military training, contract, War
  Department
description: >-
  Minutes of the special meeting of the Board of Visitors of the University of
  Virginia held on April 5, 1918, during which a contract with the War
  Department was discussed and approved to train Army Motor-truck Drivers and
  Mechanics.
attendee:
  - '@type': Person
    name: R. T. Irvine
  ...
  - '@type': Person
    name: Mr. Robertson
  - '@type': Person
    name: Mr. John Stewart Bryan
  - '@type': Person
    name: Prof. J. L. Newcomb
about:
  - '@type': Event
    name: Contract with the War Department
    description: >-
      Discussion and resolution to enter into a contract with the War Department
      to train Army personnel.
  - '@type': Event
    name: Resolution on Fire-Plug Inspection
    description: >-
      Resolution requesting the Superintendent of Grounds and Buildings to
      report on fire-plug inspections on University property.
  - '@type': Event
    name: Compilation of Acts
    description: >-
      Request for the Attorney for the Rector and Visitors to compile Acts of
      the General Assembly relevant to the University.
---
