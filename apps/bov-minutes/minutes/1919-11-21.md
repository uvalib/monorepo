...
description: >-
  ...
  discussing faculty salary increases and other administrative matters.
attendee:
  - '@type': Person
    name: R. Tate Irvine
  - '@type': Person
...
about:
  - '@type': Event
    ...
    description: >-
      Discussion on the motion to increase faculty salaries by 25% for those who
      have served for three years or more.
  - '@type': Event
    name: Bequest Acknowledgment
    description: >-
      Acknowledgment of a $5,000 bequest from Richard B. Tunstall for the Isabel
      Mercein Tunstall Library of Poetry.
---
