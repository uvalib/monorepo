...
class UpdatingElement$1 extends HTMLElement {
  ...
  static _propertyValueToAttribute(value, options) {
    ...
    const toAttribute =
      (converter && converter.toAttribute) || defaultConverter$1.toAttribute;
  ...
  _propertyToAttribute(name, value, options = defaultPropertyDeclaration$1) {
    ...
    if (attr !== undefined) {
      ...
      this._updateState =
        this._updateState | STATE_IS_REFLECTING_TO_ATTRIBUTE$1;
      if (attrValue == null) {
...
const css$1 = (strings, ...values) => {
  const cssText = values.reduce(
    (acc, v, idx) => acc + textFromCSSResult$1(v) + strings[idx + 1],
    strings[0]
  );
...
var style = css`
  :host {
    ...
    --uvalib-color-primary-text: #565656;
    --uvalib-color-error: #df1e43;
  }
