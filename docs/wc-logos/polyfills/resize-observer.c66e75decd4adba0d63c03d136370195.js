!(function (t, e) {
  ...
  function d(t) {
    ...
    if (
      ("border-box" === r.boxSizing &&
        (Math.round(c + o) !== e && (c -= f(r, "left", "right") + o),
      ...
      var p = Math.round(c + o) - e,
        v = Math.round(d + s) - n;
      1 !== Math.abs(p) && (c -= p), 1 !== Math.abs(v) && (d -= v);
    }
    return l(i.left, i.top, c, d);
  }
  var p =
    "undefined" != typeof SVGGraphicsElement
      ...
      : function (t) {
          return t instanceof a(t).SVGElement && "function" == typeof t.getBBox;
        };
  function v(t) {
    return e
      ? p(t)
  ...
  var y = "undefined" != typeof WeakMap ? new WeakMap() : new t(),
    g = function (t) {
  ...
  return (
    ...
    void 0 !== n.ResizeObserver ? n.ResizeObserver : ((n.ResizeObserver = g), g)
  );
});
