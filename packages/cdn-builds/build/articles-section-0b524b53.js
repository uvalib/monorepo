import{_ as t,n as s,a as e,b as i}from"./property-8648e151.js";import"./document-77724c06.js";import{A as l}from"./ArticlesData-f873435f.js";import{x as a}from"./lit-element-ab109411.js";import{B as r}from"./BentoSection-7c57d088.js";import"./unsafe-html-e63196f7.js";import"./SiteStyle-ee7ab697.js";var n;class o extends r{constructor(){super(),n.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Article",e(this,n,new l({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,i(this,n,"f").query=this.query,i(this,n,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}renderHiddenInput(t,s){return a`<input type="hidden" name="${t}" value="${s}" />`}renderAuthor(t){return a`<li class="bs-results--author li-1">${t.join("; ")}</li>`}renderPublicationDetails(t){return a`
