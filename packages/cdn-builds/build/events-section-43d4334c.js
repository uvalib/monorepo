import{_ as e,a as t,b as i,n as a}from"./property-fe2d5cc5.js";import{x as s}from"./lit-element-ab109411.js";import"./document-77724c06.js";import"./ArticlesData-61176dc1.js";import{E as n}from"./EventsData-f0de88b7.js";import{B as r}from"./BentoSection-69928e80.js";import"./GeneralSearchResult-331b56d5.js";import"./unsafe-html-e63196f7.js";import"./SiteStyle-8d6e2da7.js";var o;class m extends r{constructor(){super(),this.items=[],o.set(this,void 0),this.title="",t(this,o,new n,"f")}updated(e){super.updated(e),(e.has("query")||e.has("limit")||e.has("category"))&&(this.loading=!0,i(this,o,"f").query=this.query,i(this,o,"f").limit=this.limit,i(this,o,"f").category=this.category,i(this,o,"f").fetchData().then((e=>{this.items=e.items,this.loading=!1})))}static formatDate(e){return s`
