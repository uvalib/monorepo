import{_ as s,n as t,a as i,b as e,x as a}from"./property-88ac5898.js";import"./document-77724c06.js";import{C as l}from"./ArticlesData-4e187389.js";import{B as r}from"./BentoSection-7cbd507d.js";import"./unsafe-html-882321a0.js";import"./SiteStyle-4bb8cd6a.js";import"./AccessibleStyles-1e7f8a0a.js";var o;class u extends r{constructor(){super(),o.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Virgo Catalog",i(this,o,new l({query:""}),"f"),this.limit=5}updated(s){super.updated(s),(s.has("query")||s.has("limit"))&&(this.loading=!0,e(this,o,"f").query=this.query,e(this,o,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t,i;return a`
