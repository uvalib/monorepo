import{a as s,b as t}from"./query-assigned-elements-ba719eec.js";import{x as e}from"./lit-element-b1a1c7e4.js";import{o as i}from"./unsafe-html-d2a53643.js";import"./ArticlesData-e9b81d53.js";import{L as a}from"./LibGuidesData-3101faf7.js";import{B as l}from"./BentoSection-4595ae76.js";import"./SiteStyle-00ee8f65.js";var r;r=new WeakMap,window.customElements.define("libguides-section",class extends l{constructor(){super(),r.set(this,void 0),this.meta={totalResults:0},this.title="Subject Guides",s(this,r,new a({query:""}),"f")}updated(s){super.updated(s),s.has("query")&&(this.loading=!0,t(this,r,"f").query=this.query,t(this,r,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t;return e`
