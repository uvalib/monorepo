import{x as t}from"./lit-element-ab109411.js";function r(t){const r=t.match(/(\d+):(\d+)(am|pm)/i);if(r){const t=r[1],e=r[2],o=r[3].toLowerCase();return"00"===e?`${t}${o}`:`${t}:${e}${o}`}return t}function e(t){return t.replace("24hours","24 Hours").replace("ByApp","By Appt")}function o(o){return o.hours?o.hours.map((e=>t`
      ${r(e.from)} - ${r(e.to)}
