      ...
      <table ?hidden="${!this.librarySlug}" class="weekly-hours-body-section">
        ...
        <thead>
          <tr>
            ...
            ${this.library&&this.library.hours&&this.library.hours.rawDates?Object.entries(this.library.hours.rawDates).map((([t,e])=>r`
            ...
            `)):r`
              ${this.library&&Array.isArray(this.library.children)&&this.library.children.length>0&&this.library.children[0].hours&&this.library.children[0].hours.rawDates?Object.entries(this.library.children[0].hours.rawDates).map((([t,e])=>r`
                <th scope="col" aria-current="false" aria-label="${this.stringDateFormat(t,0)}" class="${t===this.todayString?"today":""}">
                  <div class="date-header">
                    <div class="date--mobile">
                      <div class="date-header-day">${this.stringDateFormat(t,2)}</div>
        ...
        <tbody>
          ${this.library&&this.library.hours?r`
            <tr>
          ...
          ${this.library&&this.library.children?this.library.children.map((t=>r`
            <tr>
              ...
              ${t.hours&&t.hours.rawDates?Object.entries(t.hours.rawDates).map((([t,e])=>r`
                <td aria-label="${this.printTimes(e)}" class="${t===this.todayString?"today":""}">
                  <div class="date--mobile">
                    <div class="date-header-day">${this.stringDateFormat(t,2)}</div>
                    <div class="date-header-month">${this.stringDateFormat(t,1)}</div>
              ...
              `)):""}
              ${t.hours&&t.hours.rawDates&&t.hours.rawDates.length<7?Array.apply(null,Array(7-t.hours.rawDates.length)).map((()=>r`<td></td>`)):""}
