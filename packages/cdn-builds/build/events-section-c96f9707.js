import{_ as e,a as t,b as a,x as i,e as s}from"./query-assigned-elements-23ba9e4f.js";import"./ArticlesData-c1e511c9.js";import{E as n}from"./EventsData-21fd59ae.js";import{B as r}from"./BentoSection-3ae60287.js";import"./GeneralSearchResult-331b56d5.js";import"./unsafe-html-b3407b2c.js";import"./SiteStyle-86c89e81.js";var o;class m extends r{constructor(){super(),this.items=[],o.set(this,void 0),this.title="",t(this,o,new n,"f")}updated(e){super.updated(e),(e.has("query")||e.has("limit")||e.has("category"))&&(this.loading=!0,a(this,o,"f").query=this.query,a(this,o,"f").limit=this.limit,a(this,o,"f").category=this.category,a(this,o,"f").fetchData().then((e=>{this.items=e.items,this.loading=!1})))}static formatDate(e){return i`
