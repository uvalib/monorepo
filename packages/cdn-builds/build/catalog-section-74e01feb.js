import{_ as s,n as t,a as i,b as e}from"./query-assigned-elements-f7cc377b.js";import{x as a}from"./lit-element-9e1ac43c.js";import{C as l}from"./ArticlesData-e6785a6b.js";import{B as r}from"./BentoSection-db7960ed.js";import"./unsafe-html-9171da0a.js";import"./SiteStyle-d4ac8580.js";var o;class n extends r{constructor(){super(),o.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Virgo Catalog",i(this,o,new l({query:""}),"f"),this.limit=5}updated(s){super.updated(s),(s.has("query")||s.has("limit"))&&(this.loading=!0,e(this,o,"f").query=this.query,e(this,o,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t,i;return a`
