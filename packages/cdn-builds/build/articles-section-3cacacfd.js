import{_ as t,e as s,a as e,b as i,x as l}from"./query-assigned-elements-23ba9e4f.js";import{A as a}from"./ArticlesData-c1e511c9.js";import{B as r}from"./BentoSection-3ae60287.js";import"./unsafe-html-b3407b2c.js";import"./SiteStyle-86c89e81.js";var n;class u extends r{constructor(){super(),n.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Article",e(this,n,new a({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,i(this,n,"f").query=this.query,i(this,n,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}renderHiddenInput(t,s){return l`<input type="hidden" name="${t}" value="${s}" />`}renderAuthor(t){return l`<li class="bs-results--author li-1">${t.join("; ")}</li>`}renderPublicationDetails(t){return l`
