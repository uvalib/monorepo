import{_ as t,n as e,a as s,b as i}from"./query-assigned-elements-f7cc377b.js";import{A as l}from"./ArticlesData-e6785a6b.js";import{x as a}from"./lit-element-9e1ac43c.js";import{B as r}from"./BentoSection-db7960ed.js";import"./unsafe-html-9171da0a.js";import"./SiteStyle-d4ac8580.js";var n;class u extends r{constructor(){super(),n.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Article",s(this,n,new l({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,i(this,n,"f").query=this.query,i(this,n,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}renderHiddenInput(t,e){return a`<input type="hidden" name="${t}" value="${e}" />`}renderAuthor(t){return a`<li class="bs-results--author li-1">${t.join("; ")}</li>`}renderPublicationDetails(t){return a`
