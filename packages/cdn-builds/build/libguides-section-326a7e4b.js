import{a as s,b as t,x as e}from"./property-4490ebb8.js";import{o as i}from"./unsafe-html-11e6b712.js";import"./document-77724c06.js";import"./ArticlesData-ef19c3aa.js";import{L as a}from"./LibGuidesData-54f85c20.js";import{B as l}from"./BentoSection-e700f572.js";import"./SiteStyle-3d98d4f6.js";import"./AccessibleStyles-e1ca487e.js";var r;r=new WeakMap,window.customElements.define("libguides-section",class extends l{constructor(){super(),r.set(this,void 0),this.meta={totalResults:0},this.title="Subject Guides",s(this,r,new a({query:""}),"f")}updated(s){super.updated(s),s.has("query")&&(this.loading=!0,t(this,r,"f").query=this.query,t(this,r,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t;return e`
