import{_ as e,a as t,b as i,n as a}from"./property-8648e151.js";import{x as s}from"./lit-element-ab109411.js";import"./document-77724c06.js";import"./ArticlesData-f873435f.js";import{E as n}from"./EventsData-1167f79a.js";import{B as r}from"./BentoSection-7c57d088.js";import"./GeneralSearchResult-331b56d5.js";import"./unsafe-html-e63196f7.js";import"./SiteStyle-ee7ab697.js";var o;class m extends r{constructor(){super(),this.items=[],o.set(this,void 0),this.title="",t(this,o,new n,"f")}updated(e){super.updated(e),(e.has("query")||e.has("limit")||e.has("category"))&&(this.loading=!0,i(this,o,"f").query=this.query,i(this,o,"f").limit=this.limit,i(this,o,"f").category=this.category,i(this,o,"f").fetchData().then((e=>{this.items=e.items,this.loading=!1})))}static formatDate(e){return s`
