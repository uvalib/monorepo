import{a as t,b as s}from"./property-8648e151.js";import{x as e}from"./lit-element-ab109411.js";import{o as i}from"./unsafe-html-e63196f7.js";import"./document-77724c06.js";import"./ArticlesData-f873435f.js";import{L as a}from"./LibGuidesData-ab039cfd.js";import{B as l}from"./BentoSection-7c57d088.js";import"./SiteStyle-ee7ab697.js";var r;r=new WeakMap,window.customElements.define("libguides-section",class extends l{constructor(){super(),r.set(this,void 0),this.meta={totalResults:0},this.title="Subject Guides",t(this,r,new a({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,s(this,r,"f").query=this.query,s(this,r,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}render(){var t,s;return e`
