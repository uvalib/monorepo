import{_ as e,n as t,a as s,b as i}from"./query-assigned-elements-8ef6cca7.js";import{x as r}from"./lit-element-9e1ac43c.js";import{o as n}from"./unsafe-html-9171da0a.js";import{M as a}from"./MLBData-c87d27d6.js";import"./ArticlesData-75bbe436.js";import{B as l}from"./BentoSection-42015d06.js";import"./document-77724c06.js";import"./GeneralSearchResult-331b56d5.js";import"./SiteStyle-35a18246.js";var d;class o extends l{constructor(){super(),d.set(this,void 0),this.items=[],this.embedded=!1,this.meta={totalResults:0},this.title="Modern Library Bibliography",s(this,d,new a({query:""}),"f"),this.limit=5}updated(e){if(super.updated(e),e.has("query")||e.has("indexYear")){if(this.loading=!0,this.indexYear){const e=`https://mlbib.library.virginia.edu/json/${this.indexYear}.json`;s(this,d,new a({query:this.query,indexes:[e]}),"f")}else s(this,d,new a({query:this.query}),"f");i(this,d,"f").fetchData().then((e=>{this.items=e.items,this.meta=e.meta,this.loading=!1}))}}highlight(e,t){const{query:s}=this,i=s.split(" ");let r="",n=-1;for(let t=0;t<i.length&&-1===n;t++){const s=new RegExp(`\\b${i[t]}\\b`,"i");n=e.search(s)}if(-1!==n){let s=Math.max(n-t,0),a=Math.min(n+i[0].length+t,e.length);" "!==e[s]&&-1!==e.lastIndexOf(" ",s)&&(s=e.lastIndexOf(" ",s))," "!==e[a]&&-1!==e.indexOf(" ",a)&&(a=e.indexOf(" ",a)),r=e.substring(s,a)}else r=e.substring(0,2*t);for(let e of i){const t=new RegExp(`(${e})`,"gi");r=r.replace(t,"<mark>$1</mark>")}return r}renderItems(){return this.items.map((e=>r`
