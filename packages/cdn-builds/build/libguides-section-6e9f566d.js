import{a as s,b as t}from"./query-assigned-elements-f7cc377b.js";import{x as e}from"./lit-element-9e1ac43c.js";import{o as i}from"./unsafe-html-9171da0a.js";import"./ArticlesData-e6785a6b.js";import{L as a}from"./LibGuidesData-f77e667b.js";import{B as l}from"./BentoSection-db7960ed.js";import"./SiteStyle-d4ac8580.js";var r;r=new WeakMap,window.customElements.define("libguides-section",class extends l{constructor(){super(),r.set(this,void 0),this.meta={totalResults:0},this.title="Subject Guides",s(this,r,new a({query:""}),"f")}updated(s){super.updated(s),s.has("query")&&(this.loading=!0,t(this,r,"f").query=this.query,t(this,r,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t;return e`
