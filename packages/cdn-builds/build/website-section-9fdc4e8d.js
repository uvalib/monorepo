import{x as t}from"./property-4490ebb8.js";import"./document-77724c06.js";import"./ArticlesData-ef19c3aa.js";import{L as e,W as s}from"./LibrariesData-d7300118.js";import{W as i,b as a}from"./WebsiteData-c3ada1a6.js";import{B as r,r as l}from"./BentoSection-e700f572.js";import{r as n}from"./LibrariesSection-5e1a8916.js";import"./GeneralSearchResult-331b56d5.js";import"./unsafe-html-11e6b712.js";import"./SiteStyle-3d98d4f6.js";import"./AccessibleStyles-e1ca487e.js";new WeakMap;window.customElements.define("website-section",class extends r{constructor(){super(),this.meta={totalResults:0},this.title="Website",this.websearch=new i}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,this.websearch.query=this.query,this.websearch.fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}renderBriefItem(s){return s instanceof e?n(s):s instanceof a?function(e){return t`  
