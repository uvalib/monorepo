...
`,styles:(e,t)=>d`
    ...
    >
        ...
        >
            <slot
                ${oe({filter:xe.slottedOptionFilter,flatten:!0,property:"slottedOptions"})}
            ></slot>
        </div>
    </template>
`,styles:(e,t)=>{const i=e.name===e.tagFor(Se);return d`
    ...
    `.withBehaviors(ne(d`
                ...
                :host([multiple]:${le}) ::slotted(${i}[aria-checked="true"]) {
                    border-color: ${re.ButtonText};
                    box-shadow: 0 0 0 calc(${x} * 1px) inset ${re.HighlightText};
                }
    ...
    `.withBehaviors(ne(d`
                ...
                :host(:not([disabled]):${le}) {
                    ...
                    box-shadow: 0 0 0 calc(${x} * 1px) ${re.Highlight};
                    color: ${re.ButtonText};
                    fill: currentcolor;
                    forced-color-adjust: none;
                }
