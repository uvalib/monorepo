import{_ as e,a as t,b as i,n as a}from"./query-assigned-elements-f7cc377b.js";import{x as s}from"./lit-element-9e1ac43c.js";import"./ArticlesData-e6785a6b.js";import{E as n}from"./EventsData-f49f01f2.js";import{B as r}from"./BentoSection-db7960ed.js";import"./GeneralSearchResult-331b56d5.js";import"./unsafe-html-9171da0a.js";import"./SiteStyle-d4ac8580.js";var o;class m extends r{constructor(){super(),this.items=[],o.set(this,void 0),this.title="",t(this,o,new n,"f")}updated(e){super.updated(e),(e.has("query")||e.has("limit")||e.has("category"))&&(this.loading=!0,i(this,o,"f").query=this.query,i(this,o,"f").limit=this.limit,i(this,o,"f").category=this.category,i(this,o,"f").fetchData().then((e=>{this.items=e.items,this.loading=!1})))}static formatDate(e){return s`
