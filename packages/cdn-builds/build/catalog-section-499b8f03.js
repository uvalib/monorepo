import{_ as t,n as s,a as i,b as e}from"./property-fe2d5cc5.js";import{x as a}from"./lit-element-ab109411.js";import"./document-77724c06.js";import{C as l}from"./ArticlesData-61176dc1.js";import{B as r}from"./BentoSection-69928e80.js";import"./unsafe-html-e63196f7.js";import"./SiteStyle-8d6e2da7.js";var o;class h extends r{constructor(){super(),o.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Virgo Catalog",i(this,o,new l({query:""}),"f"),this.limit=5}updated(t){super.updated(t),(t.has("query")||t.has("limit"))&&(this.loading=!0,e(this,o,"f").query=this.query,e(this,o,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}render(){var t,s,i;return a`
