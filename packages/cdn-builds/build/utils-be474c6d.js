import{x as t}from"./property-88ac5898.js";function r(t){const r=t.match(/(\d+):(\d+)(am|pm)/i);if(r){const t=r[1],o=r[2],e=r[3].toLowerCase();return"00"===o?`${t}${e}`:`${t}:${o}${e}`}return t}function o(t){return t.replace("24hours","24 Hours").replace("ByApp","By Appt")}function e(e){return e.hours?e.hours.map((o=>t`
      ${r(o.from)} - ${r(o.to)}
