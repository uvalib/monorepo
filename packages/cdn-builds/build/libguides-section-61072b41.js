import{a as t,b as s}from"./query-assigned-elements-8ef6cca7.js";import{x as e}from"./lit-element-9e1ac43c.js";import{o as i}from"./unsafe-html-9171da0a.js";import"./document-77724c06.js";import"./ArticlesData-75bbe436.js";import{L as a}from"./LibGuidesData-c0309b32.js";import{B as l}from"./BentoSection-42015d06.js";import"./SiteStyle-35a18246.js";var r;r=new WeakMap,window.customElements.define("libguides-section",class extends l{constructor(){super(),r.set(this,void 0),this.meta={totalResults:0},this.title="Subject Guides",t(this,r,new a({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,s(this,r,"f").query=this.query,s(this,r,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}render(){var t,s;return e`
