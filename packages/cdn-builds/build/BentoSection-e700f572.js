import{i as e,_ as i,n as t,s as o,x as r}from"./property-4490ebb8.js";import{o as s}from"./unsafe-html-11e6b712.js";import{S as n}from"./SiteStyle-3d98d4f6.js";import"./AccessibleStyles-e1ca487e.js";var a=e`
    :host {
...
`;class d extends o{constructor(){super(),this.message="",this.overlay=!1,this.book=!1,this.role="status",this.message?this.label=this.message:this.label="loading"}render(){return r`
      ...
      ${e.link?r`
        <div class="bento-section-title"><a href="${e.link}">${s(e.title)}</a></div>
      `:r`
        <div class="bento-section-title">${s(e.title)}</div>
      `}
      <div class="bento-section-desc">${s(e.description)}</div>
    `}d.styles=e`
    :host {
      display: block;
    }
  ...
  `,i([t({type:String})],d.prototype,"message",void 0),i([t({type:Boolean})],d.prototype,"overlay",void 0),i([t({type:Boolean})],d.prototype,"book",void 0),i([t({type:String,reflect:!0})],d.prototype,"role",void 0),i([t({type:String,reflect:!0,attribute:"aria-label"})],d.prototype,"label",void 0),window.customElements.define("site-spinner",d);class p extends n{constructor(){super(...arguments),this.query="",this.limit=0,this.title="",this.label="",this.items=[],this.loading=!1,this.noResultDescribe="",this.isEmptySearch=!0}static get styles(){return[...super.styles,a]}updated(e){(e.has("items")||e.has("loading"))&&(this.isEmptySearch=this.loading||!this.items||0===this.items.length)}renderBriefItem(e){return l(e)}limitTitle(e){return this.maxTitleLength&&e&&e.length>=this.maxTitleLength?`${e.substring(0,this.maxTitleLength)}…`:e}render(){return r`
