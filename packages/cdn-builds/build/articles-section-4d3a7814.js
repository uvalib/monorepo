import{_ as t,n as s,a as e,b as i,x as l}from"./property-4490ebb8.js";import"./document-77724c06.js";import{A as a}from"./ArticlesData-ef19c3aa.js";import{B as r}from"./BentoSection-e700f572.js";import"./unsafe-html-11e6b712.js";import"./SiteStyle-3d98d4f6.js";import"./AccessibleStyles-e1ca487e.js";var n;class o extends r{constructor(){super(),n.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Article",e(this,n,new a({query:""}),"f")}updated(t){super.updated(t),t.has("query")&&(this.loading=!0,i(this,n,"f").query=this.query,i(this,n,"f").fetchData({limit:this.limit}).then((t=>{this.items=t.items,this.meta=t.meta,this.loading=!1})))}renderHiddenInput(t,s){return l`<input type="hidden" name="${t}" value="${s}" />`}renderAuthor(t){return l`<li class="bs-results--author li-1">${t.join("; ")}</li>`}renderPublicationDetails(t){return l`
