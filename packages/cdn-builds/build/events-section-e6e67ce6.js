import { _ as __decorate, a as __classPrivateFieldSet, b as __classPrivateFieldGet, y, e } from './query-assigned-elements-cb6980e1.js';
import './ArticlesData-40bc37f5.js';
import { E as EventsData } from './EventsData-ea6fed49.js';
...
class EventsSection extends BentoSection {
    ...
    static dateRange(_start, _end) {
        ...
        return y `${EventsSection.formatDate(start)} - ${EventsSection.formatDate(end)}`;
    }
    ...
    render() {
        return y `
${this.title ? y `<h2>${this.limitTitle(this.title)}</h2>` : ''}
<div class="event-container">
  ${this.loading ? y `<site-spinner></site-spinner>` : ''}
  ${this.items.map((event) => y `
    <div class="event">
