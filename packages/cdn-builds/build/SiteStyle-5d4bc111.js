import { i, _ as __decorate, s, a as __classPrivateFieldSet, b as __classPrivateFieldGet, B, x, e } from './query-assigned-elements-66a11629.js';
...
class SiteStyle extends s {
    ...
    connectedCallback() {
        ...
        if (this.noShadowDom && !this.noStyle) {
            ...
            B(x `${Object.getPrototypeOf(this).constructor.styles.map((s) => s.toString().replace(/:host/m, this.tagName.toLowerCase()))}`, __classPrivateFieldGet(this, _SiteStyle_styleNode, "f"));
        }
    }
    createRenderRoot() {
        if (this.noShadowDom) {
