import{_ as s,e as t,a as i,b as e,y as a}from"./query-assigned-elements-9f2025bb.js";import{C as l}from"./ArticlesData-fb86ab76.js";import{B as r}from"./BentoSection-1a4a1a7d.js";import"./unsafe-html-deeaec8d.js";import"./SiteStyle-d7ea4a7e.js";var o;class u extends r{constructor(){super(),o.set(this,void 0),this.items=[],this.meta={totalResults:0},this.title="Virgo Catalog",i(this,o,new l({query:""}),"f"),this.limit=5}updated(s){super.updated(s),(s.has("query")||s.has("limit"))&&(this.loading=!0,e(this,o,"f").query=this.query,e(this,o,"f").fetchData({limit:this.limit}).then((s=>{this.items=s.items,this.meta=s.meta,this.loading=!1})))}render(){var s,t,i;return a`
