// patch from https://gist.github.com/lucaelin/ffa48cba2253e9ad662b71e38444a135
// fixes issue with commonjs and wds
...
export function fixExportNamedExports() {
  return {
    ...
    transform(context) {
      ...
      const nullByteURL = new URL(context.url, 'http://localhost').searchParams.get('web-dev-server-rollup-null-byte');
      if (nullByteURL && new URL(nullByteURL, 'http://localhost').searchParams.has('commonjs-module')) {
