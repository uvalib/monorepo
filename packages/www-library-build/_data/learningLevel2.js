...
module.exports = async function () {
  ...
  let json = await Cache(
    "https://drupal.lib.virginia.edu/rest/tags?_format=json",
    {
  ...
  return json
    .map((e) => {
      return {
        ...
        description: striptags(_getValue(e.description)[0]).trim(),
        icon: _getValue(e.field_url_to_icon, "uri").map((i) =>
          i.replace(
            "drupal.lib.virginia.edu/sites/default",
            "wwwstatic.lib.virginia.edu"
          )
        )[0],
